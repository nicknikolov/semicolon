...
module.exports.getLastSelection = getLastSelection
module.exports.setSelectedSketch = setSelectedSketch
module.exports.getSelectedSketch = getSelectedSketch
...
function getSelectedSketch () {
  if (!selectedSketch) selectedSketch = 'Default Sketch'
  return selectedSketch
}

function setSelectedSketch (newSketch) {
  if (newSketch) selectedSketch = newSketch
}
